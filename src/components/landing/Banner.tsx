  ...
  return (
    <div className="relative flex items-center justify-center h-screen overflow-hidden bg-cover bg-center">
      ...
      <div className="relative z-10 flex flex-col items-center text-center text-white p-8">
        ...
        <h1 className="text-5xl font-bold mb-4 drop-shadow-lg">{dict[selectedLanguage].welcome}</h1>
        <p className="text-lg mb-6 drop-shadow-md">{dict[selectedLanguage].subtitle}</p>
        <button
          onClick={handleClick}
