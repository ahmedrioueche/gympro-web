  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen">
      ...
      <div className="flex-1 flex items-center justify-center bg-white dark:bg-gray-800 p-8">
        <div className="w-full max-w-md">
          ...
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">{dict[selectedLanguage].details}</h2>
            <button
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative text-light-text-primary dark:text-dark-text-primary">
              <label htmlFor="gym-owner" className="block text-sm text-start">
            ...
            {isOwner === 'yes' && (
              <div className="relative">
                <input
                  ...
                  placeholder={dict[selectedLanguage].staffCountPlaceholder || 'How many staff members do you have?'}
                />
                <label
                  htmlFor="staff-count"
      ...
      <div className="flex-1 hidden md:flex items-center justify-center bg-light-background dark:bg-dark-background">
        <img src={details} alt={'details'} className="w-full h-auto" width={500} height={500} />
      </div>
    </div>
  );
};
