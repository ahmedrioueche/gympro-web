            ...
            <div className="container mx-auto flex flex-col items-center">
                ...
                >
                    ...
                    <h2
                        className={`text-3xl font-extrabold mb-6 ${
                            isDarkMode ? 'bg-gradient-to-r from-dark-primary to-dark-secondary' : 'bg-gradient-to-r from-light-primary to-light-secondary'
                ...
                >
                    <AiOutlineCheckCircle
                        className={`${
                            isDarkMode ? 'text-light-secondary' : 'text-dark-secondary'
                        } transition-colors duration-300`}
                    />
