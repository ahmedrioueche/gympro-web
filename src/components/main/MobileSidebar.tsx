...
const MobileSidebar: React.FC<{ isOpen: boolean; onClose: () => void }> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className={`fixed left-0 top-0 z-200 w-64 h-full bg-light-surface dark:bg-dark-surface shadow-lg transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 overflow-y-scroll scrollbar-hide`}>
