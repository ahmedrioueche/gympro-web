        ...
        <div className="space-y-3">
          {member.email && (
            <div className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
              ...
              <span>{dict[selectedLanguage].email}: {member.email}</span>
            </div>
          )}
          ...
          {member.phone && (
            <div className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
              ...
              <span>{dict[selectedLanguage].phone}: {member.phone}</span>
            </div>
          )}
          ...
          <div className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <span>{dict[selectedLanguage].joined} {new Date(member.joinDate).toLocaleDateString()}</span>
          </div>
