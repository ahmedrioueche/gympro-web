      ...
      <div className="max-w-[2000px] w-full mx-auto py-4 px-4 md:px-6">
        <div className="flex items-center justify-between font-f1 relative">
          <div className="flex justify-start">
            ...
            <button
              className={`hidden md:flex ${isMidSizedScreen? 'ml-16' : 'ml-28'} px-4 py-2 md:px-5 md:justify-center rounded-md text-sm bg-light-primary dark:bg-dark-primary text-dark-text-primary  hover:bg-light-secondary dark:hover:bg-dark-secondary transition-colors duration-300 items-center group`}
          ...
          {!isMidSizedScreen && (
            ...
            <button
              className="hidden md:flex px-4 py-2 md:px-5 md:justify-center rounded-md text-sm bg-light-primary dark:bg-dark-primary text-dark-text-primary  hover:bg-light-secondary dark:hover:bg-dark-secondary transition-colors duration-300 items-center group"
            ...
            <div className="hidden md:block text-base dark:text-dark-text-secondary text-light-text-secondary hover:cursor-pointer transition duration-300
                    px-4 py-2 rounded-lg border border-transparent hover:border-light-text-primary hover:text-light-text-primary dark:hover:text-dark-text-primary dark:hover:border-dark-text-primary">
                Feedback
            </div>
