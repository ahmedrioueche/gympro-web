    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-light-surface dark:bg-dark-surface text-light-text-primary dark:text-dark-text-primary rounded-lg shadow-lg p-6 w-full max-w-md">
        <div className="flex items-center mb-4">
          {Icon && (
            <div className="mr-2">
              <Icon size={20} className="text-light-primary dark:text-dark-primary mr-1" />
            </div>
          )}
          <h2 className="text-lg font-bold">{title}</h2>
          <button
            onClick={onClose}
            className="p-2 rounded-full hover:bg-light-primary dark:hover:bg-dark-primary hover:text-white ml-auto"
          >
            <FaTimes size={12} />
          </button>
        </div>
        ...
        <div className="flex justify-end space-x-40 mt-6">
          ...
          <button
            ...
            className="flex-1 justify-center items-center px-4 py-2 text-base font-semibold text-white bg-light-secondary dark:bg-dark-secondary rounded-lg hover:bg-light-accentSecondary dark:hover:bg-dark-accentSecondary rounded-lgtransition-colors duration-200"
            disabled={isLoading}
          >
  ...
  return (
    <div className="relative z-0 p-6 bg-light-background dark:bg-dark-background scrollbar-hide h-full overflow-auto ">
      ...
      <div className="relative flex flex-col w-full z-10">
        {' '}
        {/* Added z-10 to layer content above the background */}
      ...
      <Modal
        onSave={() => handleSave({ email, password })}
      ...
      <Modal
        onSave={() => handleSave({ dataSharing, twoFactorAuth })}
      ...
      <Modal
        onSave={() => handleSave({ notificationEmail, notificationPush })}
            ...
            <div className="flex items-center justify-between">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  checked={bgImages}
                  onChange={e => setBgImages(e.target.checked)}
                  className="sr-only peer"
                />
                <div className="w-11 h-6 bg-gray-200 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:bg-light-primary dark:peer-checked:bg-dark-primary after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
              </label>
