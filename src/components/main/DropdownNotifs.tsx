      ...
      >
        ...
        >
          {sortedNotifs.length === 0 ? (
            <p className="text-center text-light-text-primary dark:text-dark-text-primary">
              {dict[selectedLanguage].noNotification}
            </p>
          ) : (
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-row mb-1">
                    ...
                    {notif.description &&
                      ...
                      notif.description !== 'undefined' &&
                      notif.description !== 'null' &&
                      notif.description.trim() !== '' && <p className="text-base">: {notif.description}</p>}
                  </div>
                  <p className="text-xs">{capitalizeFirstLetter(formatDateTime(new Date(notif.createdAt)))}</p>
                </div>
              </div>
            ))
          )}
